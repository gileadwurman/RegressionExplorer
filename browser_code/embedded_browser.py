...
class MainFrame(tk.Frame):
    ...
    def get_browser_frame(self):
        logger.debug("MainFrame.get_browser_frame")
        if self.browser_frame:
...
class BrowserFrame(tk.Frame):
    ...
    def get_window_handle(self):
        logger.debug("BrowserFrame.get_window_handle")
        if self.winfo_id() > 0:
    ...
    def on_root_close(self):
        logger.debug("BrowserFrame.on_root_close")
        if self.browser:
    ...
    def clear_browser_references(self):
        ...
        logger.debug("BrowserFrame.clear_browser_references")
        self.browser = None
...
class LoadHandler(object):
    ...
    def OnLoadStart(self, browser, **_):
        logger.debug("LoadHandler.OnLoadStart")
