...
#    Sep 23, 2022 11:39:00 PM PDT  platform: Windows NT
...
class MainWindow:
    def __init__(self, top=None):
        ...
        self.TabGroup.place(relx=0.0, rely=0.0, relheight=0.998, relwidth=1.001)
        ...
        self.LeftPaneGroup.place(relx=0.029, rely=0.043, relheight=0.877
                , relwidth=0.226)
...
class ImportWindow:
    def __init__(self, top=None):
        ...
        self.InputFileField.place(relx=0.117, rely=0.234, relheight=0.077
                , relwidth=0.627)
        ...
        self.SelectFileButton.place(relx=0.767, rely=0.234, height=25, width=76)
        ...
        self.ImportKwargsField.place(relx=0.117, rely=0.443, relheight=0.077
                , relwidth=0.627)
        ...
        self.TLabel1.place(relx=0.117, rely=0.147, height=20, width=65)
        ...
        self.TLabel2.place(relx=0.117, rely=0.355, height=19, width=95)
        ...
        self.TButton2.place(relx=0.35, rely=0.59, height=25, width=76)
        self.TButton2.configure(command=explorer_gui_support.import_file)
        self.TButton2.configure(takefocus="")
        self.TButton2.configure(text='''Import''')
        self.TButton2.configure(compound='left')

        self.TButton3 = ttk.Button(self.top)
        self.TButton3.place(relx=0.5, rely=0.59, height=25, width=76)
        self.TButton3.configure(command=explorer_gui_support.import_cancel)
        self.TButton3.configure(takefocus="")
        self.TButton3.configure(text='''Cancel''')
        self.TButton3.configure(compound='left')

        self.TButton4 = ttk.Button(self.top)
        self.TButton4.place(relx=0.767, rely=0.44, height=25, width=76)
        self.TButton4.configure(takefocus="")
        self.TButton4.configure(text='''Validate''')
