...
#  Sep 23, 2022 05:03:51 PM PDT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 1020x701+165+157
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
proc vTclWindow.top2 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
    wm focusmodel $top passive
    wm geometry $top 600x273+610+260
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    set vTcl(real_top) {}
    ttk::entry $top.tEn63 \
        -font TkTextFont -textvariable input_file_str -foreground {} \
    ...
    ttk::entry $top.tEn65 \
        -font TkTextFont -textvariable import_kwargs_str -foreground {} \
        -background {} -takefocus {} -cursor ibeam 
    ...
    vTcl:DefineAlias "$top.tBu68" "TButton2" vTcl:WidgetProc "ImportWindow" 1
    ttk::style configure TButton -background $vTcl(actual_gui_bg)
    ttk::style configure TButton -foreground $vTcl(actual_gui_fg)
    ttk::style configure TButton -font "$vTcl(actual_gui_font_dft_desc)"
    ttk::button $top.tBu69 \
        -command import_cancel -takefocus {} -text Cancel -compound left 
    vTcl:DefineAlias "$top.tBu69" "TButton3" vTcl:WidgetProc "ImportWindow" 1
    ttk::style configure TButton -background $vTcl(actual_gui_bg)
    ttk::style configure TButton -foreground $vTcl(actual_gui_fg)
    ttk::style configure TButton -font "$vTcl(actual_gui_font_dft_desc)"
    ttk::button $top.tBu70 \
        -takefocus {} -text Validate -compound left 
    vTcl:DefineAlias "$top.tBu70" "TButton4" vTcl:WidgetProc "ImportWindow" 1
    menu $top.m46 \
    ...
    ###################
    place $top.tEn63 \
        -in $top -x 0 -relx 0.117 -y 0 -rely 0.236 -width 376 -relwidth 0 \
        -height 21 -relheight 0 -anchor nw -bordermode ignore 
    place $top.tBu64 \
        -in $top -x 0 -relx 0.767 -y 0 -rely 0.236 -width 76 -relwidth 0 \
        -height 25 -relheight 0 -anchor nw -bordermode ignore 
    place $top.tEn65 \
        -in $top -x 0 -relx 0.117 -y 0 -rely 0.442 -width 376 -relwidth 0 \
        -height 21 -relheight 0 -anchor nw -bordermode ignore 
    place $top.tLa66 \
        -in $top -x 0 -relx 0.117 -y 0 -rely 0.147 -width 0 -relwidth 0.108 \
        -height 0 -relheight 0.071 -anchor nw -bordermode ignore 
    place $top.tLa67 \
        -in $top -x 0 -relx 0.117 -y 0 -rely 0.354 -width 0 -relwidth 0.158 \
        -height 0 -relheight 0.071 -anchor nw -bordermode ignore 
    place $top.tBu68 \
        -in $top -x 0 -relx 0.35 -y 0 -rely 0.59 -width 76 -relwidth 0 \
        -height 25 -relheight 0 -anchor nw -bordermode ignore 
    place $top.tBu69 \
        -in $top -x 0 -relx 0.5 -y 0 -rely 0.59 -width 76 -relwidth 0 \
        -height 25 -relheight 0 -anchor nw -bordermode ignore 
    place $top.tBu70 \
        -in $top -x 0 -relx 0.767 -y 0 -rely 0.44 -width 76 -relwidth 0 \
        -height 25 -relheight 0 -anchor nw -bordermode ignore 
